...
export class AnalystAgent {
  ...
  analyzeStockoutRisks(
    ...
    const lowStockVariants = variants.filter(
      (v) => v.stock !== undefined && v.stock < 10,
    );
